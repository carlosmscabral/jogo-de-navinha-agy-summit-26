...
function buildModerationPrompt(callsign: string): string {
  return [
    ...
    '2. Diminutivo, aumentativo ou eufemismo de órgão sexual conta exatamente como o',
    '   termo direto contaria. Essa deformação é justamente a manobra usada para',
    '   escapar do filtro simples, e tratá-la como inofensiva anula a sua função aqui.',
    '',
    'No sentido oposto, e com o mesmo peso: um nome apenas estranho, genérico ou sem',
    'sentido óbvio é SEGURO, e vocabulário de combate condizente com um jogo de nave',
    'é temático, não ofensivo. Reprovar um visitante inocente custa mais caro do que',
    'deixar passar um nome meramente bobo.',
    '',
